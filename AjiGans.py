...
class instagram:
 ...
 |_____|_| |_|___/\__\__,_|\__, |_|  \__,_|_| |_| |_| 
                            __/ |                     
                           |___/    \33[32;1mAuthor : Mahesa Aji👾             
\33[1;33m[*]----------------------------------------------
[*]    Sebuah tools untuk henk akun IG presiden:v
[*]    Jangan lupa bahagia:)
[*]----------------------------------------------
\033[96m
 ...
 *->{C}  {H}[ 085877812378 ]{C}
 ...
 [{M}!{C}] nyalakan mode pesawat  setiap 2 menit tod
	...
	def checkAPI(self,user,pw):
		try:
			...
			if "userId" in x.text:
				nama,pengikut,mengikut,postingan=self.APIinfo(user)
				print(f"""\r   
  {H}*->{C} {H}Hoki Lu Njing 🗿Mahesa Aji
  ...
  {H}*->{C} {H}Mengikuti  : {H}{mengikut}{C}
  {H}*->{C} {H}Postingan  : {H}{postingan}{C}
  {H}*->{C} {H}Silahkan Login su
				""")
			elif 'checkpoint_url' in x.text:
				nama,pengikut,mengikut,postingan=self.APIinfo(user)
				print(f"""\r   
  {M}*->{C} CHEKCPOINT GOBLOKK 👾
